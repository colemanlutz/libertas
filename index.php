            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-text">
                        <span class="name">Lady Liberty</span>
                        <hr class="star-light">
                        <span class="skills">An Ignite III Project by Code Brothers</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 text-center">
                    <p>Lady Liberty is your personal insurance consultant. She can answer questions about your policy, and direct you to where to get more information. </p>
                </div>
                <div class="col-lg-4"></div>
            </div>
        </div>
    ...
    <footer class="text-center">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; Code Brothers 2015
                    </div>
                </div>
            </div>
        </div>
